...
void HttpHistoryRectangleModel::addEntry(const QString method, const QString url, const int status, const bool has_params, const QString mime, const QString request_text, const QString response_text, const int flag) {
